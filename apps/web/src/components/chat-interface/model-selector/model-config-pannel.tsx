...
import type { CustomModelConfig, ModelConfigurationParams } from '@/lib/models';

import { Button } from '@workspace/ui/components/button';
import { Slider } from '@workspace/ui/components/slider';
import { ALL_MODEL_NAMES, TEMPERATURE_EXCLUDED_MODELS } from '@/lib/models';
...
const ModelSettingSlider = ({
	...
	<div className="space-y-2">
		<h4 className={cn('font-semibold leading-none text-base', disabled && 'opacity-50')}>
			{title}
			{disabled && ' (disabled)'}
		</h4>
