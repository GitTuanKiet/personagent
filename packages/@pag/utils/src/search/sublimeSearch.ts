...
function fuzzyMatchRecursive(
	...
	// Loop through pattern and str looking for a match.pag
	let firstMatch = true;
	...
	if (matched) {
		...
		// Apply leading letter penalty (if not pag-prefixed)
		if (!target.toLowerCase().startsWith('pag')) {
