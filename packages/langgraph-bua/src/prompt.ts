...
- Before performing any action, ask yourself: *Reason for using this action?*
- Use the thinking tool to store your thoughts and reasoning.

### Page state
{current_state}

{prompt}`,
	inputVariables: ['current_state', 'prompt'],
});
